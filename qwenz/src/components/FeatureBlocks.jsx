  ...
  return (
    <section className="w-full flex flex-col">
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        {/* Left Dark Side */}
        <div
          className="bg-gradient-to-br from-blue-900 via-black to-black flex items-center justify-center p-10"
          data-aos="fade-right"
        >
          <img
            src="/images/img2.PNG"
        ...
        {/* Right Light Side */}
        <div
          className="bg-gray-50 flex flex-col justify-center p-10"
          data-aos="fade-left"
        >
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        ...
        <div
          className="bg-gradient-to-br from-green-200 to-green-400 flex items-center justify-center p-10"
          data-aos="fade-left"
        >
          <img
