    ...
    <section className="w-full flex flex-col">
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        ...
        <div className="bg-gray-50 flex flex-col justify-center p-10">
          ...
          <div className="flex gap-0.9 mb-6">
            <span className="bg-white rounded-full px-6 py-4 shadow text-4xl font-extrabold text-gray-600">
              +
            </span>
            <span className="bg-white rounded-full px-6 py-4 shadow text-4xl font-extrabold text-gray-600">
              -
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        ...
        <div className="bg-white flex flex-col justify-center p-10">
          {/* Signs on top of details */}
          <div className="flex gap-0.9 mb-6">
            <span className="bg-white rounded-full px-6 py-4 shadow text-3xl font-bold text-gray-700">
              $
            </span>
            <span className="bg-white rounded-full px-6 py-4 shadow text-3xl font-bold text-gray-700">
              ⇄
